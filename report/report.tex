...
Modellauto mit Motor
Computer z.B. Raspberry-Pi oder Arduino
Akku f"ur Computer
Kabel f"ur die Verbindungen
Ultraschallsensoren f"ur Umgebungserfassung
Wir haben uns dann f"ur ein Mini Cooper Modellauto in 1:30 Format entschieden, f"ur einen Raspberry-Pi, f"ur einen 5600 m/A/h Akku, Jumper-Stecker f"ur die Verbindungen und HC-SR04 Umgebungserfassungs-Module mit Ultraschall, welche extra f"ur den Raspberry-Pi abgestimmt waren.
...
- 1 Lan Port
- 1 Sound Port
- 1 Mikro USB Port  f"ur Akku
- 40 GPIO Pins zur Daten"ubertragung
Akku:  - Akkumulator
- USB – Mikro USB Kabel
Breadboard:  - Board f"ur Jumper-Stecker
Jumper Stecker
Ultraschallsensoren: - 4 Pins (GND, ECHO, VCC, TRIG)
    - 1 Empf"anger
    - 1 Sender
Modellauto:  -  Chassis mit Motoren f"ur Steuern und Beschleunigen
   - Karosserie aus Plastik nur Verzierung und Antenne
   - Fernbedienung mit 4 Kn"opfen
...
Wir haben das Auto auf die Stra"se gesetzt und haben es einige 10 male fahren gelassen und mithilfe von einer Stoppuhr und einer physikalischen Formel haben wir unterschiedliche Faktoren berechnet, dessen Ergebnisse wir selbstverst"andlich in unserem Laborbuch notiert haben:
Geschwindigkeit: V = S/T: - ~ 2.34 m/s, raue Stra"se
  - ~ 2.52 m/s, Fu"sweg, Steinplatten,
90° Kurve: - ~ 16,5° ± 1° Radneigung
 - ~ 87 – 90 cm (Stra"se), ~ 83 – 85 cm (Fu"sweg) f"ur 90°-Kurve
Bremsweg: < 5cm
...
Aber wie genau diese Tests mit den einzelnen Codes ausgef"uhrt wurden l"asst sich aus Teil „Software“ sehr gut herleiten.

Um all dies ordentlich ausf"uhren zu k"onnen, stand uns die gesamte Zeit ein Fernseher und eine Tastatur zur Verf"ugung um die Eingaben f"ur das Programm zu t"atigen und sie auf einer grafischen Oberfl"ache darstellen zu k"onnen.

Schnell stellten wir jedoch fest, als wir alle Ultraschallsensoren montieren wollten, dass der Rapberry-Pi nur zwei Stromversorgungspins hat, da wir aber vier Ultraschallsensoren hatten ben"otigten wir entweder noch zwei Stromquellen oder eine andere L"osung.
...
Da das Auto zu 85 \% aus Plastik  besteht war es eine Leichtigkeit das Auto zu bearbeiten.
Wir gingen also in die Werkstatt, die Timos Opa (Erich Redweik) zur Verf"ugung stellte, in welcher wir die Werkzeuge vorfinden konnten, um solche Bearbeitungen durchzuf"uhren.
...
Wir bearbeiteten das Auto nun so, dass alle unn"otigen Verzierungen im Auto wie Armaturenbrett und Sitze herauszunehmen waren. Diese Teile schmissen wir dann weg, da wir die nicht mehr brauchten.
...
Das Problem war: jeder der Motoren funktioniert so, dass die Spannung, welche auf den Motor gegeben wird, positiv oder negativ ist und damit die Richtung des Motors eingestellt wird, sprich Rechts-Links Lenken oder Vorw"arts-R"uckw"arts Fahren. Das diese Motoren so funktionieren wurde uns erst von Herr Redweik erkl"art.
...
Wir wussten nicht ganz was so ein Relais ist, geschweige denn wo wir so etwas herbekommen w"urden.
...
Da kein Laden in unserer n"ahe solche Relais besa"sen, rief Timo bei seinem Opa in Essen an, Fritz Tillmann, da Timo wusste das dort eine Conrad-Filiale war.
...
Wir verzichteten bei den Relais auf einen Test und bauten jene sofort ein.
Das klappte auch super einfach, da Timo Opa dem Paket eine Skizze des Schaltplans beilegte und wir nur noch die einzelnen Kabel an die Richtige Position bringen mussten.

Die Relais wurden so angeschlossen, dass der VCC Anschluss mit einem Jumper-Stecker zu den der Ultraschallsensoren hinzugef"ugt wurde, der GND Anschluss an ein Ground Pin verbunden wurde und die Anschl"usse der einzelnen Relais Schalter an jeweils einen GPIO-Pin.
...
Da diese Tests einwandfrei funktionierten wurde auch Platz f"ur die Relais-Platine gemacht und sie wurde mit Schrauben an dem Chassis montiert. Als das geschafft war wurde das Programm bearbeitet sodass auch die Relais eingeschlossen waren.
